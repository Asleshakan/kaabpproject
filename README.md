...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 45406b24-b3f6-42d6-a2f1-ebb99a9a1253
```

> `45406b24-b3f6-42d6-a2f1-ebb99a9a1253` is the password of the certificate, you can change it to any password you want.
